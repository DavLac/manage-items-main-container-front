...
import {UserManagement} from "@bit/davlac.manage-items.user-component";
...
export const tabDatas = [
    {title: "Users", icon: <AccountCircleIcon/>, content: <UserManagement/>, path: '/users', role: UserScopes.ADMIN},
